...
type ConfigSchema struct {
	...
	Dev                                       bool            `env:"SEERLINK_DEV" default:"false"`
	...
	LinkContractAddress                       string          `env:"SEER_CONTRACT_ADDRESS" default:"0x514910771AF9Ca656af840dff83E8264EcF986CA"`
	...
	TLSHost                                   string          `env:"SEERLINK_TLS_HOST" `
	TLSKeyPath                                string          `env:"TLS_KEY_PATH" `
	TLSPort                                   uint16          `env:"SEERLINK_TLS_PORT" default:"6689"`
	TLSRedirect                               bool            `env:"SEERLINK_TLS_REDIRECT" default:"false"`
