...
func TestClient_RunNodeShowsEnv(t *testing.T) {
	...
	store.Config.Set("SEER_CONTRACT_ADDRESS", "0x514910771AF9Ca656af840dff83E8264EcF986CA")
	store.Config.Set("FLAGS_CONTRACT_ADDRESS", "0x4A5b9B4aD08616D11F3A402FF7cBEAcB732a76C6")
	store.Config.Set("SEERLINK_PORT", 6688)
	...
	assert.Contains(t, logs, "SEERLINK_PORT: 6688\\n")
	...
	assert.Contains(t, logs, "SEER_CONTRACT_ADDRESS: 0x514910771AF9Ca656af840dff83E8264EcF986CA\\n")
	...
	assert.Contains(t, logs, "ROOT: /tmp/seerlink_test/")
