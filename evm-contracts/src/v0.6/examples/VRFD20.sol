...
/**
 * @notice A Seerlink VRF consumer which uses randomness to mimic the rolling
 * of a 20 sided die
...
contract VRFD20 is VRFConsumerBase, Owned {
     ...
     *
     * @dev NETWORK: KOVAN
     * @dev   Seerlink VRF Coordinator address: 0xdD3782915140c8f3b190B5D67eAc6dc5760C46E9
