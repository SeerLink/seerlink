...
/**
 * @title The Seerlink Coordinator handles oracle service aggreements between one or more oracles
 */
contract Coordinator is SeerlinkRequestInterface, CoordinatorInterface, ServiceAgreementDecoder, OracleSignaturesDecoder {
   ...
   * Emits OracleRequest event for Seerlink nodes to detect.
  ...
  /**
   * @dev Necessary to implement SeerlinkRequestInterface
   */
