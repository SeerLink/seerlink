...
import (
	...
	seerlink "github.com/SeerLink/seerlink/core/services/seerlink"

	job "github.com/SeerLink/seerlink/core/services/job"

	mock "github.com/stretchr/testify/mock"

	models "github.com/SeerLink/seerlink/core/store/models"

	null "gopkg.in/guregu/null.v4"

	packr "github.com/gobuffalo/packr"

	store "github.com/SeerLink/seerlink/core/store"

	synchronization "github.com/SeerLink/seerlink/core/services/synchronization"
...
func (_m *Application) GetExternalInitiatorManager() seerlink.ExternalInitiatorManager {
	...
	var r0 seerlink.ExternalInitiatorManager
	if rf, ok := ret.Get(0).(func() seerlink.ExternalInitiatorManager); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(seerlink.ExternalInitiatorManager)
		}
	}
