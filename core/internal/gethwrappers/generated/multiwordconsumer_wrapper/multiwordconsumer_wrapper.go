...
type MultiWordConsumerSeerlinkCancelledIterator struct {
	Event *MultiWordConsumerSeerlinkCancelled
...
func (it *MultiWordConsumerSeerlinkCancelledIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MultiWordConsumerSeerlinkCancelled)
...
type MultiWordConsumerSeerlinkCancelled struct {
	Id  [32]byte
	Raw types.Log
}
...
func (_MultiWordConsumer *MultiWordConsumerFilterer) FilterSeerlinkCancelled(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerSeerlinkCancelledIterator, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.FilterLogs(opts, "SeerlinkCancelled", idRule)
	if err != nil {
		return nil, err
	}
	return &MultiWordConsumerSeerlinkCancelledIterator{contract: _MultiWordConsumer.contract, event: "SeerlinkCancelled", logs: logs, sub: sub}, nil
}
...
func (_MultiWordConsumer *MultiWordConsumerFilterer) WatchSeerlinkCancelled(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerSeerlinkCancelled, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.WatchLogs(opts, "SeerlinkCancelled", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(MultiWordConsumerSeerlinkCancelled)
				if err := _MultiWordConsumer.contract.UnpackLog(event, "SeerlinkCancelled", log); err != nil {
					return err
				}
				event.Raw = log
...
type MultiWordConsumerSeerlinkFulfilledIterator struct {
	Event *MultiWordConsumerSeerlinkFulfilled
...
func (it *MultiWordConsumerSeerlinkFulfilledIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MultiWordConsumerSeerlinkFulfilled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type MultiWordConsumerSeerlinkFulfilled struct {
	Id  [32]byte
	Raw types.Log
}
...
func (_MultiWordConsumer *MultiWordConsumerFilterer) FilterSeerlinkFulfilled(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerSeerlinkFulfilledIterator, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.FilterLogs(opts, "SeerlinkFulfilled", idRule)
	if err != nil {
		return nil, err
	}
	return &MultiWordConsumerSeerlinkFulfilledIterator{contract: _MultiWordConsumer.contract, event: "SeerlinkFulfilled", logs: logs, sub: sub}, nil
}
...
func (_MultiWordConsumer *MultiWordConsumerFilterer) WatchSeerlinkFulfilled(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerSeerlinkFulfilled, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.WatchLogs(opts, "SeerlinkFulfilled", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(MultiWordConsumerSeerlinkFulfilled)
				if err := _MultiWordConsumer.contract.UnpackLog(event, "SeerlinkFulfilled", log); err != nil {
					return err
				}
				event.Raw = log
...
type MultiWordConsumerSeerlinkRequestedIterator struct {
	Event *MultiWordConsumerSeerlinkRequested
...
func (it *MultiWordConsumerSeerlinkRequestedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MultiWordConsumerSeerlinkRequested)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type MultiWordConsumerSeerlinkRequested struct {
	Id  [32]byte
	Raw types.Log
}
...
func (_MultiWordConsumer *MultiWordConsumerFilterer) FilterSeerlinkRequested(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerSeerlinkRequestedIterator, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.FilterLogs(opts, "SeerlinkRequested", idRule)
	if err != nil {
		return nil, err
	}
	return &MultiWordConsumerSeerlinkRequestedIterator{contract: _MultiWordConsumer.contract, event: "SeerlinkRequested", logs: logs, sub: sub}, nil
}
...
func (_MultiWordConsumer *MultiWordConsumerFilterer) WatchSeerlinkRequested(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerSeerlinkRequested, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.WatchLogs(opts, "SeerlinkRequested", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(MultiWordConsumerSeerlinkRequested)
				if err := _MultiWordConsumer.contract.UnpackLog(event, "SeerlinkRequested", log); err != nil {
					return err
				}
				event.Raw = log
...
type MultiWordConsumerInterface interface {
	...
	FilterSeerlinkCancelled(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerSeerlinkCancelledIterator, error)

	WatchSeerlinkCancelled(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerSeerlinkCancelled, id [][32]byte) (event.Subscription, error)

	ParseSeerlinkCancelled(log types.Log) (*MultiWordConsumerSeerlinkCancelled, error)

	FilterSeerlinkFulfilled(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerSeerlinkFulfilledIterator, error)

	WatchSeerlinkFulfilled(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerSeerlinkFulfilled, id [][32]byte) (event.Subscription, error)

	ParseSeerlinkFulfilled(log types.Log) (*MultiWordConsumerSeerlinkFulfilled, error)

	FilterSeerlinkRequested(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerSeerlinkRequestedIterator, error)

	WatchSeerlinkRequested(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerSeerlinkRequested, id [][32]byte) (event.Subscription, error)

	ParseSeerlinkRequested(log types.Log) (*MultiWordConsumerSeerlinkRequested, error)
