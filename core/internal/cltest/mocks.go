...
func (f InstanceAppFactory) NewApplication(config *orm.Config, onConnectCallbacks ...func(seerlink.Application)) seerlink.Application {
	return f.App
}

type seededAppFactory struct {
	Application seerlink.Application
}

func (s seededAppFactory) NewApplication(config *orm.Config, onConnectCallbacks ...func(seerlink.Application)) seerlink.Application {
...
func (r BlockedRunner) Run(app seerlink.Application) error {
	<-r.Done
	return nil
}
...
func (r EmptyRunner) Run(app seerlink.Application) error {
	return nil
}
...
func MustRandomUser() models.User {
	email := fmt.Sprintf("user-%v@seerlink.test", NewRandomInt64())
