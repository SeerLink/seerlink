...
// line. When you run the binary, for example `./seerlink n`,
// client.RunNode is called to start the Seerlink core.
// Similarly, running `./seerlink j` returns information on
// all jobs in the node, and `./seerlink s` with another
