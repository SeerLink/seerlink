...
func (ec *explorerClient) connect(ctx context.Context) error {
	...
	authHeader.Add("X-Explore-Seerlink-Accesskey", ec.accessKey)
	authHeader.Add("X-Explore-Seerlink-Secret", ec.secret)
	authHeader.Add("X-Explore-Seerlink-Core-Version", static.Version)
	authHeader.Add("X-Explore-Seerlink-Core-Sha", static.Sha)
