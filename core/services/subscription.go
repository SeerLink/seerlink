...
func StartJobSubscription(job models.JobSpec, head *models.Head, store *strpkg.Store, runManager RunManager) (JobSubscription, error) {
	...
	initrs := job.InitiatorsFor(models.LogBasedSeerlinkJobInitiators...)
...
// for use with a Seerlink Initiator. Initiator specific functionality is delegated
// to the callback.
...
// https://seerlink/pull/600#issuecomment-426320971
