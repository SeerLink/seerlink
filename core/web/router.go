...
func explorerStatus(app seerlink.Application) gin.HandlerFunc {
...
func Router(app seerlink.Application) *gin.Engine {
	engine := gin.New()
	store := app.GetStore()
	config := store.Config
...
func metricRoutes(app seerlink.Application, r *gin.RouterGroup) {
...
func sessionRoutes(app seerlink.Application, r *gin.RouterGroup) {
...
func v2Routes(app seerlink.Application, r *gin.RouterGroup) {
